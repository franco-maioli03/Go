...
let imgArray = [
    "static/img/img/hand_rock.png",
    "static/img/img/hand_paper.png",
    "static/img/img/hand_scissors.png",
];
...
function choose(x) {
    ...
    .then(data => {
        ...
        if (x == 0){
            document.getElementById("player_choice").innerHTML = "The player chose STONE.";
        } else if (x == 1){
